...
pushd "$ADDED_DIR" &> /dev/null
    ...
    chmod ug+x kieserver-setup.sh kieserver-config.sh kieserver-install.sh kieserver-pull.sh kieserver-verify.sh kieserver-launch.sh
    ...
    cp -p kieserver-setup.sh ${JBOSS_HOME}/bin/launch
popd &> /dev/null
