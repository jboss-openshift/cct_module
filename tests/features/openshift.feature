...
Feature: tests for all openshift images
  ...
  @base @base_jdk @jboss-eap-6/eap64-openshift @jboss-eap-7/eap70-openshift @webserver_httpd @webserver_tomcat7 @webserver_tomcat8 @amq @datavirt @brms @bpms @kieserver @decisionserver @processserver @jboss-datagrid-6 @jboss-datagrid-7
  ...
  @base @base_jdk @jboss-eap-6/eap64-openshift @jboss-eap-7/eap70-openshift @webserver_httpd @webserver_tomcat7 @webserver_tomcat8 @amq @datavirt @brms @bpms @kieserver @decisionserver @processserver @jboss-datagrid-6 @jboss-datagrid-7 @openjdk
  Scenario: Check that labels are correctly set
    Given image is built
