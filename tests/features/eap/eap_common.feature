...
Feature: Openshift EAP common tests (EAP and EAP derived images)
  ...
  @ignore @jboss-eap-7/eap70-openshift
  Scenario: Management interface is secured (no warning message)
    When container is ready
    # The below should complete faster than 'should not contain' alone
  ...
  @jboss-eap-6/eap64-openshift @jboss-eap-7/eap70-openshift @jboss-decisionserver-6 @jboss-processserver-6 @redhat-sso-7
  ...
  @jboss-eap-6/eap64-openshift @jboss-eap-7/eap70-openshift @jboss-decisionserver-6 @jboss-processserver-6
  ...
  @jboss-eap-6/eap64-openshift @jboss-eap-7/eap70-openshift @redhat-sso-7
  # CLOUD-295
  ...
  @jboss-eap-7/eap70-openshift @jboss-eap-6/eap64-openshift
  ...
  @jboss-eap-7/eap70-openshift @jboss-eap-6/eap64-openshift @redhat-sso-7 @jboss-datavirt-6
  ...
  @jboss-eap-7/eap70-openshift @jboss-eap-6/eap64-openshift @redhat-sso-7 @jboss-datavirt-6 @jboss-datagrid-6 @jboss-datagrid-7 @jboss-processserver-6 @jboss-decisionserver-6
