...
Feature: Openshift common tests
  ...
  @jboss-eap-6/eap64-openshift @jboss-eap-7/eap70-openshift @decisionserver @processserver @webserver_tomcat7 @webserver_tomcat8 @amq @jboss-datagrid-6 @jboss-datagrid-7
