...
OUTPUT=/tmp/liveness-kie-output
ERROR=/tmp/liveness-kie-error
LOG=/tmp/liveness-kie-log
...
# Execute the parent liveness probe
$JBOSS_HOME/bin/livenessProbe_eap.sh $COUNT_ORIG $SLEEP $DEBUG_SCRIPT
EAP_RESULT=$?
